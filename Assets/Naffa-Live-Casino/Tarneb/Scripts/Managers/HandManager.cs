...
namespace Tarneb41.Scripts
{
    ...
    public class HandManager : MonoBehaviour
    {
        ...
        public Vector2[] cardPosVec;
        public Card[] cards;
        public float timerC{get; set;}
        ...
        public void ChangeTableImage(Sprite image)
        {
            TableImage.sprite = image;
        }
        void CreateTeams(PlayerHandler FirstPlayer)
        {
            ...
            _player2.cardsHolderUI.GetComponent<RectTransform>().anchoredPosition = cardPosVec[1];
            _player3.cardsHolderUI.GetComponent<RectTransform>().anchoredPosition = cardPosVec[2];
            _player4.cardsHolderUI.GetComponent<RectTransform>().anchoredPosition = cardPosVec[3];
